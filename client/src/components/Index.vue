				...
				<div class="fundpress-event-wraper">
					<div class="fundpress-single-event-wraper row">
						...
						<div class="col-md-6 fundpress-event-details">
							...
							<p>In a time of overwhelming emotions, sadness, and pain, the last thing the  families need to be worrying obligations associated with this tragic loss. He's not the kind to ask for help, but Zach.</p>
					...
					<div class="fundpress-single-event-wraper row">
						...
						<div class="col-md-6 fundpress-event-details">
							<h3 class="color-white xs-post-title fundpress-post-title">Otimize Training & Recovery Using HRV and CorSense</h3>
							<p>In a time of overwhelming emotions, sadness, and pain, the last thing the  families need to be worrying obligations associated with this tragic loss. He's not the kind to ask for help, but Zach.</p>
						...
						<div class="fundpress-grid-item-content xs-box-shadow fundpress-from-journal">
							...
							<div class="xs-item-content fundpress-item-content xs-content-padding bg-color-white">
								<div class="entry-header">
									<div class="post-meta">
										<ul class="xs-simple-tag fundpress-simple-tag">
											<li><a rel="tag" href="#">Charity</a></li>
											<li><a rel="tag" href="#">Travel</a></li>
										</ul>
									</div>
									
									<h4 class="entry-title">
										<a href="blog-single.html" class="xs-post-title color-navy-blue fundpress-post-title">BIKI: First Bionic Wireless Under water Fish Drone</a>
									</h4>
								</div>

								<a href="blog-single.html" class="xs-btn round-btn navy-blue-btn">learn more</a>
						...
						<div class="fundpress-grid-item-content xs-box-shadow fundpress-from-journal">
							...
							<div class="xs-item-content fundpress-item-content xs-content-padding bg-color-white">
								<div class="entry-header">
									<div class="post-meta">
										<ul class="xs-simple-tag fundpress-simple-tag">
											<li><a rel="tag" href="#">Games</a></li>
											<li><a rel="tag" href="#">Film</a></li>
										</ul>
									</div>
									
									<h4 class="entry-title">
										<a href="blog-single.html" class="xs-post-title color-navy-blue fundpress-post-title">Brilliant After All, A New Album by Rebecca: Help poor people</a>
									</h4>
								</div>
						...
						<div class="fundpress-grid-item-content xs-box-shadow fundpress-from-journal">
							...
							<div class="xs-item-content fundpress-item-content xs-content-padding bg-color-white">
								<div class="entry-header">
									<div class="post-meta">
										<ul class="xs-simple-tag fundpress-simple-tag">
											<li><a rel="tag" href="#">Construction</a></li>
											<li><a rel="tag" href="#">Project</a></li>
										</ul>
									</div>
									<h4 class="entry-title">
										<a href="blog-single.html" class="xs-post-title color-navy-blue fundpress-post-title">DACBerry PRO – Professional Soundcard for Raspberry Pi</a>
									</h4>
								</div>
