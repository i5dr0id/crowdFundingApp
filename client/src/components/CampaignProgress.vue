<template>
    ...
    <section class="xs-inner-welcome-section fundpress-inner-welcome-section fundpress-inner-bg-1 parallax-window" data-parallax="scroll" data-image-src="static/images/background/progress_bg.jpg">
        ...
        <div class="container">
            <div class="fundpress-inner-welcome-content xs-inner-welcome-content">
                <h2 class="color-white">FundPress In Progress Projects</h2>
                <p class="color-white xs-mb-20">People just like you have raised more money on FundPress than anywhere else. </p>
                <ul class="xs-breadcumb fundpress-breadcumb">
                    <li><a href="index-2.html" class="color-white"> Home /</a> Progress</li>
                </ul>
            </div>
        </div>
    </section>
            ...
            <div class="xs-isotope-grid-wraper">
                <div class="xs-isotope-nav fundpress-isotope-nav">
                    <ul id="filters" class="option-set clearfix" data-option-key="filter">
                        ...
                        <li><a href="#" data-option-value=".comics">Comics</a></li>
                        <li><a href="#" data-option-value=".crafts">Crafts</a></li>
                        <li><a href="#" data-option-value=".dance">Dance</a></li>
                        <li><a href="#" data-option-value=".design">Design</a></li>
                        <li><a href="#" data-option-value=".fashion">Fashion</a></li>
                        <li><a href="#" data-option-value=".food">Food</a></li>
                        <li><a href="#" data-option-value=".games">Games</a></li>
                        <li><a href="#" data-option-value=".filandvideo">Film & Video</a></li>
                        <li><a href="#" data-option-value=".journalism">Journalism</a></li>
    ...
    </section>	<!-- End in progress section -->
    </main>
    </div>
</template>
