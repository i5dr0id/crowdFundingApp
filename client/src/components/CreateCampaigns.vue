				...
				<form v-on:submit="addCampaign">
					...
					<div class="form-row">
						<div class="col-md-6 mb-6">
							...
							<input type="text" v-model="fname" class="form-control" id="fn" placeholder="First name"  required>

						</div>
						<div class="col-md-6 mb-6">
							<label for="">Last name</label>
							<input type="text" v-model="lname" class="form-control" id="ln" placeholder="Last name" required>
						</div>
					...
					<div class="form-row">
						<div class="form-group col-md-6">
							...
							<input type="text" v-model="alias" class="form-control" id="inputAlias" placeholder="Alias">
						</div>
						<div class="form-group col-md-6">
					...
					<div class="form-row">
						<div class="col-md-6 mb-6">
							...
							<input type="text" v-model="facebook" class="form-control" id="fbL" placeholder="http://www.facebook.com/candidate"  required>
					...
					<div class="card card-body bg-light">
						...
						<div class="col-md-6 mb-6">
							...
							<input type="text" v-model="state" class="form-control" id="st" placeholder="State"  required>

						</div>
						<div class="col-md-6 mb-6">
							<label for="">City</label>
							<input type="text" v-model="city" class="form-control" id="ct" placeholder="City" required>
						</div>
					...
					<div class="form-row">
						<div class="col-md-6 mb-6">
							...
							<input type="text" v-model="polparty" class="form-control" id="pp" placeholder="Political party"  required>

						</div>
						<div class="col-md-6 mb-6">
							<label for="">Position/Office</label>
							<input type="text" v-model="office" class="form-control" id="rf" placeholder="Running for" required>
						</div>
					...
					<div class="form-row">
						...
						<div class="col-md-6 mb-6">
							...
							<input type="text" v-model="video" class="form-control" id="yt" placeholder="https://www.youtube.com/watch?"  required>
          ...
          <!--  -->
					...
					<div class="form-row">
						<div class="card-picture thumbnail">
							<img ref="camimg" src="https://upload.wikimedia.org/wikipedia/commons/7/7c/Profile_avatar_placeholder_large.png" id="img-preview" class="img-thumbnail"/>
							<label class="file-upload-container" for="file-upload">
								<input v-on:change="uploadFile" id="file-upload" type="file" style="display:none;">
								Select an Image
							</label>
						</div>
...
export default {
  ...
  methods: {
    addCampaign(e) {
      ...
      this.axios.post('https://161c4278.ngrok.io/aspirants/', this.data).then(response => {
