	...
	<div class="container">
		<div class="fundpress-inner-welcome-content">
			...
			<ul class="xs-breadcumb fundpress-breadcumb">
				<li><a href="index-2.html" class="color-white"> Home /</a> About US</li>
			</ul>
		</div>
	</div>
</section>
...
<!-- Mirrored from demo.xpeedstudio.com/html/fundpress/about.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 10 Feb 2018 22:35:22 GMT -->
